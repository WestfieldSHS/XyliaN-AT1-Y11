...
def teacher_info():
    print("\nTeacher Login-------------------:")
    teacher = teacher_aunthentication() #Call teacher authentication function to handle login/signup process
    return teacher
...
def load_teacher_data(name):
    ...
    new_teacher = {
        ...
        "class_codes": [],
        "classes": {}   # class_code : [student_names]
    }
